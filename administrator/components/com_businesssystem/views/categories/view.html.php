 ...
 */
class BusinessSystemViewCategories extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('Categories'), 'file');
        ...
        if (file_exists($formPath)) {
         ...
         if(!empty($this->items)){
                    //JToolbarHelper::custom('categories.featured', 'featured.png', 'featured_f2.png', 'Featured', true);
                    //JToolbarHelper::custom('categories.unfeatured', 'unfeatured.png', 'featured_f2.png', 'Unfeatured', true);
                }
