 ...
 */
class BusinessSystemViewReceipts extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        if (file_exists($formPath)) {
         ...
         if(!empty($this->items)){
                    //JToolbarHelper::custom('receipts.featured', 'featured.png', 'featured_f2.png', 'Featured', true);
                    //JToolbarHelper::custom('receipts.unfeatured', 'unfeatured.png', 'featured_f2.png', 'Unfeatured', true);
                }
