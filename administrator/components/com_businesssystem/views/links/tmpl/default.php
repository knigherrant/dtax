...
<div class="businesssystem">
    <form action="<?php echo JRoute::_('index.php?option=com_businesssystem&view=links'); ?>" method="post" name="adminForm" id="adminForm">
                ...
                <tr class="row<?php echo $i % 2; ?>">
                    ...
                    <td data-field="<?php echo JText::_('Title');?>">
                        ...
                        if ($canEdit) : ?>
                            ...
                            <div>
                                <a href="<?php echo JRoute::_('index.php?option=com_businesssystem&task=link.edit&id='.(int) $item->id); ?>">
