 ...
 */
class BusinessSystemModelTaxreturn extends JModelAdmin
{
	/**
	 ...
	 * @since	1.6
	 */
	public function getTable($type = 'taxreturn', $prefix = 'BusinessSystemTable', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_businesssystem.taxreturn', 'taxreturn', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_businesssystem.edit.taxreturn.data', array());
