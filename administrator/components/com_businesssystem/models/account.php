 ...
 */
class BusinessSystemModelAccount extends JModelAdmin
{
	/**
	 ...
	 * @since	1.6
	 */
	public function getTable($type = 'account', $prefix = 'BusinessSystemTable', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_businesssystem.account', 'account', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_businesssystem.edit.account.data', array());
	...
	public function getItem($pk = null)
	{
        ...
        function save($data) {
            ...
            if(!$data['userid']){
                if($user = jSont::saveUser($data)){
                    $data['userid'] = $user->id;
                    return parent::save($data);
                }
                return false;
            }else{
                if(jSont::editUser($data['userid'], $data)) return parent::save($data);
            }
        }
