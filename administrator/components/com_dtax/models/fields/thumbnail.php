...
class JFormFieldThumbnail extends JFormField
{
	...
	protected function getInput()
	{
        ...
        if(!$this->value){
            ...
            $image = JUri::root().'administrator/components/com_dtax/assets/images/nothumbnail.png';
        }else{
                ...
                <ul class="dropdown-menu">
                    <li id="thumbnail-choose-existing" class="dropdown-link">
                        <div id="image-selector" class="image-selector">
                            ...
                            <a class="modal modal-button btn" rel="{'handler': 'iframe', 'size': {'x': 690}}" href="index.php?option=com_dtax&view=files&layout=select&tmpl=component&ctn=thumbs&ctn_type=image&field=<?php echo $this->id;?>"><?php echo JText::_('Choose existing image')?></a>
                        </div>
                    </li>
                    <li class="divider"></li>
