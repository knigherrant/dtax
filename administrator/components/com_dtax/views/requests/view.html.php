 ...
 */
class DTaxViewRequests extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('Prayer Requests'), 'requests.png');
        ...
        if (file_exists($formPath)) {
         ...
         if(!empty($this->items)){
                    //JToolbarHelper::custom('requests.featured', 'featured.png', 'featured_f2.png', 'Featured', true);
                    //JToolbarHelper::custom('requests.unfeatured', 'unfeatured.png', 'featured_f2.png', 'Unfeatured', true);
                }
