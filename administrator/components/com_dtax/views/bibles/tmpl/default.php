...
<form action="<?php echo JRoute::_('index.php?option=com_dtax&view=bibles'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <table class="table table-striped">
        <thead>
            <tr>
				...
				<th class="left">
					<?php echo JHtml::_('grid.sort',  'Documents', 'a.link', $listDirn, $listOrder); ?>
				</th>
                                <th class="left">
					<?php echo JHtml::_('grid.sort',  'Recording', 'a.audio', $listDirn, $listOrder); ?>
				</th>
                ...
                <?php /*if (isset($this->items[0]->ordering)) : ?>
                    <th width="10%">
                        ...
                        <?php if ($canOrder && $saveOrder) : ?>
                            <?php echo JHtml::_('grid.order', $this->items, 'filesave.png', 'bibles.saveorder'); ?>
                        <?php endif; ?>
                    </th>
                <?php endif; */?>
            ...
            foreach ($this->items as $i => $item) :
                ...
                <tr class="row<?php echo $i % 2; ?>">
					...
					<?php if (isset($item->checked_out) && $item->checked_out) : ?>
						<?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'bibles.', $canCheckin); ?>
					<?php endif; ?>
					<?php if ($canEdit): ?>
						<a href="<?php echo JRoute::_('index.php?option=com_dtax&view=bible&layout=view&id=' . (int) $item->id); ?>">
					...
					<?php endif; ?>
						...
						<?php echo $item->link; ?>
                                        ...
                                        <td data-field="Recording">
						<?php echo jSont::playAudio($item->audio); ?>
					</td>
