...
<form action="<?php echo JRoute::_('index.php?option=com_dtax&view=events'); ?>" method="post" name="adminForm" id="adminForm">
                ...
                <tr class="row<?php echo $i % 2; ?>">
                    ...
                    <?php if($item->featured){ ?>
                                        ...
                                        <a href="#" onclick="return listItemTask('cb<?php echo $i; ?>','events.unfeatured')" class="btn btn-micro hasTooltip active" title="" data-original-title="Toggle featured status.">
                                            <img src="<?php echo JURI::base(); ?>components/com_dtax/assets/images/featured.png" alt="Featured">
                                        </a>
                                    <?php }else{ ?>
                                        <a href="#" onclick="return listItemTask('cb<?php echo $i; ?>','events.featured')" class="btn btn-micro hasTooltip" title="" data-original-title="Toggle featured status.">
                                            <img src="<?php echo JURI::base(); ?>components/com_dtax/assets/images/disabled.png" alt="Featured">
                                        </a>
                                    <?php } ?>
                                </td>
					...
					<?php endif; ?>
					<?php if ($canEdit): ?>
						<a href="<?php echo JRoute::_('index.php?option=com_dtax&view=event&layout=view&id=' . (int) $item->id); ?>">
