...
<form action="<?php echo JRoute::_('index.php?option=com_dtax&view=profiles&layout=testimonials'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <table class="table table-striped">
        <thead>
            <tr>
				...
				<th class="left">
					<?php echo JHtml::_('grid.sort',  'Testimonials', 'a.testimonials', $listDirn, $listOrder); ?>
				</th>
    ...
    <div>
        <input type="hidden" name="task" value="" />
		 <input type="hidden" name="layout" value="testimonials" />
