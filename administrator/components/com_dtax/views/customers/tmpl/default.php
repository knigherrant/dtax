...
<form action="<?php echo JRoute::_('index.php?option=com_dtax&view=customers'); ?>" method="post" name="adminForm" id="adminForm">
            ...
            <tr>
				...
				<th class="left">
					<?php echo JHtml::_('grid.sort',  'CPA', 'c.cpa', $listDirn, $listOrder); ?>
                                ...
                                <th class="left">
					<?php echo JHtml::_('grid.sort',  'Tax Form', 'c.income_tax_form', $listDirn, $listOrder); ?>
				</th>
        ...
        <tbody>
            ...
            foreach ($this->items as $i => $item) :
                ...
                <tr class="row<?php echo $i % 2; ?>">
					...
					<?php endif; ?>
					<?php if ($canEdit): ?>
						<a href="<?php echo JRoute::_('index.php?option=com_dtax&task=customer.edit&id=' . (int) $item->id); ?>">
					...
					<?php endif; ?>
						...
						<?php echo $item->cpa; ?>
                                        ...
                                        <td data-field="Tax Form">
						<?php echo $item->income_tax_form; ?>
					</td>
