...
$doc->addScript(JUri::base() . 'components/com_dtax/assets/js/json2.js');
$doc->addScript(JUri::base() . 'components/com_dtax/assets/js/jsconfigs.js');
?>
...
<div class="signaturedoc">
    <form action="<?php echo JRoute::_('index.php?option=com_dtax')?>" method="post" enctype="multipart/form-data" name="adminForm" id="configs-form" class="form-validate dam-dashboad">
