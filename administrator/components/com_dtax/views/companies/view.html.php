 ...
 */
class DTaxViewCompanies extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('Company Manager'), 'user');
		if($this->getLayout() =='testimonials'){
			JToolBarHelper::title(JText::_('Companies Testimonials'), 'companies.png');
			return;
		}
