...
<form action="<?php echo JRoute::_('index.php?option=com_dtax&view=companies'); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <tbody>
            ...
            foreach ($this->items as $i => $item) :
                ...
                <tr class="row<?php echo $i % 2; ?>">
					...
					<?php endif; ?>
					<?php if ($canEdit): ?>
						<a href="<?php echo JRoute::_('index.php?option=com_dtax&task=company.edit&id=' . (int) $item->id); ?>">
