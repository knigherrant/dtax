 ...
 */
class DTaxViewEmails extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('Emails'), 'file');

        //Check if the form exists before showing the add/edit buttons
        $formPath = JPATH_COMPONENT_ADMINISTRATOR . '/views/email';
        if (file_exists($formPath)) {
         ...
         if(!empty($this->items)){
                    //JToolbarHelper::custom('emails.featured', 'featured.png', 'featured_f2.png', 'Featured', true);
                    //JToolbarHelper::custom('emails.unfeatured', 'unfeatured.png', 'featured_f2.png', 'Unfeatured', true);
                }
