 ...
 */
class BusinessSystemModelLinks extends JModelList {
    ...
    protected function getListQuery() {
		...
		$query->from('`#__businesssystem_links` AS a');
		...
		if (!empty($search))
		{
			...
			else
			{
				...
				$query->where('( a.`customer` LIKE ' . $search . '  OR  a.`date_updated` LIKE ' . $search . ' )');
			}
		}
