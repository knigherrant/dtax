...
<form action="<?php echo JRoute::_('index.php?option=com_businesssystem&view=cpas'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <table class="table table-striped">
        <thead>
            <tr>
				...
				<th class="left">
					<?php echo JHtml::_('grid.sort',  'BDS', 'a.firstname', $listDirn, $listOrder); ?>
				</th>
        ...
        <tbody>
            ...
            foreach ($this->items as $i => $item) :
                ...
                <tr class="row<?php echo $i % 2; ?>">
					...
					<?php endif; ?>
					<?php if ($canEdit): ?>
						<a href="<?php echo JRoute::_('index.php?option=com_businesssystem&task=cpa.edit&id=' . (int) $item->id); ?>">
