...
<form action="<?php echo JRoute::_('index.php?option=com_businesssystem&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="cpa-form" class="form-validate">
        ...
        <legend><?php echo JText::_('BDS');?></legend>
            <div class="clearfix fltlft span9">
                ...
                <div class="span12">
                    <!--
                    <div class="control-group span6">
                        <div class="controlsx"><a href="index.php?option=com_businesssystem&view=location&layout=edit&tmpl=component" rel="{handler: 'iframe', size: {x:600, y:600}}" class="btn btn-small btn-success modal">Add BDS</a></div>
                    </div>
                    -->
