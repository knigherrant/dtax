 ...
 */
class BusinessSystemViewInvoices extends JViewLegacy
{
	protected $items;
		...
		$canDo	= BusinessSystemHelper::getActions($state->get('filter.category_id'));
          ...
          /*
            JHtmlSidebar::addFilter(
                ...
                'filter_published',
                JHtml::_('select.options', BusinessSystemHelper::getPublishedOptions(), "value", "text", $this->state->get('filter.state'), true)
            );

            if(BusinessSystemHelper::isUseCat()) JHtmlSidebar::addFilter(
                JText::_('JOPTION_SELECT_CATEGORY'),
                'filter_category',
                JHtml::_('select.options', BusinessSystemHelper::getCategoryOptions(), "value", "text", $this->state->get('filter.category'), true)
            );

            JHtmlSidebar::addFilter(
                JText::sprintf('COM_BUSINESSSYSTEM_FILTER_SELECT_LABEL', JText::_('COM_BUSINESSSYSTEM_OWNER')),
                'filter_owner',
                JHtml::_('select.options', BusinessSystemHelper::getUserOptions(), "value", "text", $this->state->get('filter.owner'), true)
            );
            */
	}
