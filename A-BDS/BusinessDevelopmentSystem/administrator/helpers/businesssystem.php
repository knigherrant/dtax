...
class jSont extends BusinessSystemHelper{
    ...
    public static function menuSiderbar(){
        ...
        $menus = array(
            'cpas' => JText::_('Main BDS'),
            'locations' => JText::_('BDS'),
            'customers' => JText::_('COM_BUSINESSSYSTEM_TITLE_CUSTOMERS'),
            'companies' => JText::_('Company'),
            'invoices' => JText::_('COM_BUSINESSSYSTEM_TITLE_INVOICES'),
            'expenses' => JText::_('COM_BUSINESSSYSTEM_TITLE_EXPENSES'),
            'receipts' => JText::_('COM_BUSINESSSYSTEM_TITLE_RECEIPTS'),
            'mileages' => JText::_('COM_BUSINESSSYSTEM_TITLE_MILEAGES'),
            'taxreturns' => JText::_('COM_BUSINESSSYSTEM_TITLE_TAXRETURNS'),
            'links' => JText::_('COM_BUSINESSSYSTEM_TITLE_LINKS'),
            'configs' => JText::_('COM_BUSINESSSYSTEM_TITLE_CONFIG'),
            //'reports' => JText::_('COM_BUSINESSSYSTEM_TITLE_REPORTS'),
        );
        ob_start();
        ?><div id="BusinessSystemMenu">
            <div class="jMenu-businesssystem">
                <ul class="jsont-menu">
                    <?php foreach ($menus as $view=>$text){ ?>
                        ...
                        <li class="frontend <?php echo $selected; ?>">
                            <a class="<?php echo $selected; ?>" href="index.php?option=com_businesssystem&view=<?php echo $view; ?>" title="<?php echo $text; ?>">
                                <img src="<?php echo JURI::root(); ?>components/com_businesssystem/assets/images/items/<?php echo $view; ?>.png" />
...
class BusinessSystemHelper {
    ...
    public static function addSubmenu($vName = '') {
			...
			JText::_('COM_BUSINESSSYSTEM_TITLE_PROFILES'),
			'index.php?option=com_businesssystem&view=profiles',
			$vName == 'profiles'
		);
		JSubMenuHelper::addEntry(
			JText::_('COM_BUSINESSSYSTEM_TITLE_REQUESTS'),
			'index.php?option=com_businesssystem&view=requests',
			$vName == 'requests'
		);
		JSubMenuHelper::addEntry(
			JText::_('COM_BUSINESSSYSTEM_TITLE_WARRIORS'),
			'index.php?option=com_businesssystem&view=warriors',
			$vName == 'warriors'
		);
		JSubMenuHelper::addEntry(
			JText::_('COM_BUSINESSSYSTEM_TITLE_LINKS'),
			'index.php?option=com_businesssystem&view=links',
			$vName == 'links'
		);
		JSubMenuHelper::addEntry(
			JText::_('COM_BUSINESSSYSTEM_TITLE_EVENTS'),
			'index.php?option=com_businesssystem&view=events',
			$vName == 'events'
		);
