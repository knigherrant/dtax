 ...
 * @since  1.6
 */
class BusinessSystemTablelink extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__businesssystem_links', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_businesssystem.links.' . $array['id']))
		{
			$actions         = JAccess::getActions('com_businesssystem', 'links');
			$default_actions = JAccess::getAssetRules('com_businesssystem.links.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_businesssystem.links.' . (int) $this->$k;
	}
