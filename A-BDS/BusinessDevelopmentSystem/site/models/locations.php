 ...
 */
class BusinessSystemModelLocations extends JModelList {
    ...
    protected function getListQuery() {
        ...
        $query->select(
                $this->getState(
						...
						CONCAT(c.firstname, " " ,c.midname, " " ,c.lastname) as cpa,
						CONCAT(a.firstname, " " ,a.midname, " " ,a.lastname) as name'
                )
        );
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('LOWER(a.company) LIKE ' . $search);
            }
        }
      
        JST::dbwhere($query, 'locations', 'a');
