 ...
 */
class BusinessSystemModelMileages extends JModelList {
    ...
    protected function getListQuery() {
        ...
        $query->from('`#__businesssystem_mileages` AS a');
