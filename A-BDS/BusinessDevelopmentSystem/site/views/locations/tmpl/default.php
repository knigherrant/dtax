...
?>
<?php echo JST::header(); ?>
<?php echo JST::toolbar('location', true); ?>

<form action="<?php echo JRoute::_('index.php?option=com_businesssystem&view=locations'); ?>" method="post" name="adminForm" id="adminForm">
   <div class="jsContents form-horizontal row-fluid jscustom12">  
    <div id="j-main-container">
        <legend><?php echo JText::_('BDSs');?></legend>
        <?php JST::tabBDS(); ?>
    ...
    <table class="table table-striped">
        <thead>
            <tr>
				...
				<th class="left">
					<?php echo JHtml::_('grid.sort',  'Main BDS', 'cpa', $listDirn, $listOrder); ?>
				</th>
        ...
        <tbody>
            ...
            foreach ($this->items as $i => $item) :
                ...
                <tr class="row<?php echo $i % 2; ?>">
					...
					<?php endif; ?>
					<?php if ($canEdit): ?>
						<a href="<?php echo JRoute::_('index.php?option=com_businesssystem&task=location.edit&id=' . (int) $item->id); ?>">
