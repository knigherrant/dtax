...
--
-- Table structure for table `d_assets`
--
...
--
-- Dumping data for table `d_assets`
--
...
(59, 1, 107, 108, 1, 'com_dtax.expense.2', 'com_dtax.expense.2', '{}'),
(60, 1, 109, 110, 1, 'com_dtax.expense.3', 'com_dtax.expense.3', '{}'),
(62, 1, 111, 112, 1, 'com_dtax.expense.5', 'com_dtax.expense.5', '{}'),
(63, 1, 113, 114, 1, 'com_dtax.expense.6', 'com_dtax.expense.6', '{}'),
(64, 1, 115, 116, 1, 'com_dtax.expense.7', 'com_dtax.expense.7', '[]'),
(65, 1, 117, 118, 1, 'com_businesssystem', 'com_businesssystem', '{}');

-- --------------------------------------------------------

--
-- Table structure for table `d_associations`
--

CREATE TABLE `d_associations` (
...
--
-- Table structure for table `d_banner_clients`
--

CREATE TABLE `d_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `d_banner_tracks`
--

CREATE TABLE `d_banner_tracks` (
...
--
-- Table structure for table `d_businesssystem_accounts`
--

CREATE TABLE `d_businesssystem_accounts` (
...
--
-- Dumping data for table `d_businesssystem_accounts`
--
...
--
-- Table structure for table `d_businesssystem_company`
--

CREATE TABLE `d_businesssystem_company` (
  `id` int(11) UNSIGNED NOT NULL,
  `userid` int(11) NOT NULL,
...
--
-- Table structure for table `d_businesssystem_config`
--
...
--
-- Table structure for table `d_businesssystem_cpas`
--

CREATE TABLE `d_businesssystem_cpas` (
  `id` int(11) UNSIGNED NOT NULL,
...
--
-- Table structure for table `d_businesssystem_invoices`
--

CREATE TABLE `d_businesssystem_invoices` (
  `id` int(11) UNSIGNED NOT NULL,
  `cpaid` int(11) NOT NULL,
...
--
-- Table structure for table `d_businesssystem_links`
--

CREATE TABLE `d_businesssystem_links` (
  `id` int(11) UNSIGNED NOT NULL,
  `company` varchar(255) NOT NULL,
...
--
-- Table structure for table `d_businesssystem_locations`
--

CREATE TABLE `d_businesssystem_locations` (
  `id` int(11) UNSIGNED NOT NULL,
...
--
-- Table structure for table `d_businesssystem_mileages`
--

CREATE TABLE `d_businesssystem_mileages` (
  `id` int(11) UNSIGNED NOT NULL,
  `cpaid` int(11) NOT NULL,
  `company` varchar(255) NOT NULL,
...
--
-- Table structure for table `d_businesssystem_receipts`
--

CREATE TABLE `d_businesssystem_receipts` (
  `id` int(11) UNSIGNED NOT NULL,
  `cpaid` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `company` varchar(255) NOT NULL,
  `merchant` varchar(255) NOT NULL,
...
--
-- Table structure for table `d_businesssystem_taxreturns`
--

CREATE TABLE `d_businesssystem_taxreturns` (
  `id` int(11) UNSIGNED NOT NULL,
...
INSERT INTO `d_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 70, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 70, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 70, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 70, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 70, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 70, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `d_contact_details`
--

CREATE TABLE `d_contact_details` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `d_content`
--
...
--
-- Table structure for table `d_contentitem_tag_map`
--

CREATE TABLE `d_contentitem_tag_map` (
...
--
-- Table structure for table `d_content_frontpage`
--

CREATE TABLE `d_content_frontpage` (
...
--
-- Table structure for table `d_content_rating`
--

CREATE TABLE `d_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `d_content_types`
--

CREATE TABLE `d_content_types` (
...
--
-- Dumping data for table `d_content_types`
--

INSERT INTO `d_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `d_core_log_searches`
--

CREATE TABLE `d_core_log_searches` (
...
--
-- Table structure for table `d_dtax_appointments`
--

CREATE TABLE `d_dtax_appointments` (
  `id` int(11) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `d_dtax_appointments`
--

INSERT INTO `d_dtax_appointments` (`id`, `taxpayer`, `phone`, `email`, `service`, `notes`, `appdate`, `apptime`, `created`, `created_by`) VALUES
(9, 'John Doe', '0899999432', 'aaaxxxx@gmail.com', 'Buy Domain', 'clause specifies which record or records that should be deleted. If you omit the WHERE clause, all ', '2017-04-03', '09:15 AM', '2017-04-08 17:26:09', 70),
(10, 'Jeam Tayler', '08999999545', 'Jeam@gmail.com', 'rwerewrewr', 'clause specifies which record or records that should be deleted. If you omit the WHERE clause, all ', '2017-04-10', '12:15 AM', '2017-04-08 17:31:15', 70),
(11, 'Linda Johnson', '0899999432', 'Johnson@gmail.com', '42423', 'Delete Data From a MySQL Table Using MySQLi ', '2017-04-09', '02:00 AM', '2017-04-08 17:32:18', 70);

-- --------------------------------------------------------

--
-- Table structure for table `d_dtax_company`
--

CREATE TABLE `d_dtax_company` (
  `id` int(11) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `ordering` int(11) NOT NULL,
  `userid` int(11) NOT NULL,
  ...
  `state` varchar(255) NOT NULL,
  `server_color` varchar(255) NOT NULL,
  ...
  `enlist` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `d_dtax_company`
--
...
--
-- Table structure for table `d_dtax_config`
--

CREATE TABLE `d_dtax_config` (
  `id` int(11) UNSIGNED NOT NULL,
  `categories_invoice` text NOT NULL,
  `categories_expenses` text NOT NULL,
  `categories_receipt` text NOT NULL,
...
--
-- Dumping data for table `d_dtax_config`
--
...
CREATE TABLE `d_dtax_email` (
  ...
  `fkey` int(11) NOT NULL,
  `created` varchar(255) COLLATE latin1_general_cs NOT NULL,
  `enlist` varchar(255) COLLATE latin1_general_cs NOT NULL,
  `company` varchar(255) COLLATE latin1_general_cs NOT NULL,
  `company_location` varchar(255) COLLATE latin1_general_cs NOT NULL,
  `company_email` varchar(255) COLLATE latin1_general_cs NOT NULL,
  `preparer` varchar(255) COLLATE latin1_general_cs NOT NULL,
  `preparer_email` varchar(255) COLLATE latin1_general_cs NOT NULL,
  `preparer_location` varchar(255) COLLATE latin1_general_cs NOT NULL,
  `created_by` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs;

--
-- Dumping data for table `d_dtax_email`
--

INSERT INTO `d_dtax_email` (`id`, `cpaid`, `company_id`, `employee_id`, `taxpayer`, `phone`, `email`, `reason`, `image`, `fkey`, `created`, `enlist`, `company`, `company_location`, `company_email`, `preparer`, `preparer_email`, `preparer_location`, `created_by`) VALUES
(5, 62, 0, 0, 'John Doe', '0899999432', 'aaaxxxx@gmail.com', 'Additional Documents', 'images/dtax/1491673991_432423423.png', 0, '2017-04-08 17:53:11', '', '', '', '', '', '', '', 70),
(7, 64, 0, 0, 'tesstttt', '0899999432', 'aaaxxxx@gmail.com', 'rewrerr', '', 0, '2017-04-09 17:25:07', '', '', '', '', '', '', '', 76);

-- --------------------------------------------------------

--
-- Table structure for table `d_dtax_employees`
--

CREATE TABLE `d_dtax_employees` (
  `id` int(11) UNSIGNED NOT NULL,
  `userid` int(11) NOT NULL,
  `company_id` int(11) NOT NULL,
...
INSERT INTO `d_dtax_employees` (`id`, `userid`, `company_id`, `office_id`, `employee`, `title`, `phone`, `email`, `image`, `operation`, `about`, `created`, `created_by`) VALUES
(4, 78, 1, 0, 'Elvis Ricado', 'Owner', '0899999432', 'e1@gmail.com', '', 'clause specifies which record or records that should be deleted. If you omit the WHERE clause, all ', 'clause specifies which record or records that should be deleted. If you omit the WHERE clause, all ', '2017-04-08 17:15:49', 70),
(5, 79, 1, 0, 'Jeremy Bruce', 'Account Manager', '08999999999', 'e2@gmail.com', '', 'clause specifies which record or records that should be deleted. If you omit the WHERE clause, all ', 'clause specifies which record or records that should be deleted. If you omit the WHERE clause, all ', '2017-04-08 17:18:38', 70),
(6, 80, 0, 12, 'tessttt 111', 'tessttt 111', '0899999432', 'jjjjjj@gmail.com', '', 'jjjjjj', 'jjjjjj', '2017-04-09 17:20:33', 76);

-- --------------------------------------------------------

--
-- Table structure for table `d_dtax_links`
--
...
--
-- Table structure for table `d_dtax_locations`
--

CREATE TABLE `d_dtax_locations` (
  `id` int(11) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `d_dtax_locations`
--

INSERT INTO `d_dtax_locations` (`id`, `name`, `address`, `latitude`, `longitude`, `featured`, `phone`, `created_by`, `email`, `created`, `city`, `zip`, `state`, `userid`) VALUES
(12, 'Dokataxe Office', '1900 E Sahara Ave', '48.87174227510659', '2.353905658721942', 0, '44444444444', 70, 'jdev@gmail.com', '2017-04-09 15:33:32', 'New York', '700000', 'New York', 76),
(13, 'Montana Office', '123 East lake', '48.871509398258624', '2.3562874603271666', 0, '0899999432', 70, 'dev@gmail.com', '2017-04-08 17:34:46', 'New York', '234444', 'New York', 77),
(14, 'test', 'test', '48.87163642212825', '2.3557939338684264', 0, 'test', 70, 'test@gmail.com', '2017-04-10 05:38:54', 'test', 'test', 'test', 81);

-- --------------------------------------------------------

--
-- Table structure for table `d_dtax_taxreturns`
--

CREATE TABLE `d_dtax_taxreturns` (
  `id` int(11) UNSIGNED NOT NULL,
  `tax_firstname` varchar(255) NOT NULL,
  `tax_midname` varchar(255) NOT NULL,
  `tax_lastname` varchar(255) NOT NULL,
...
--
-- Dumping data for table `d_extensions`
--

INSERT INTO `d_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"LIB_JOOMLA","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"441a533a00131610f69fca9b22f36c05"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10001, 'com_dtax', 'component', 'com_dtax', '', 1, 1, 0, 0, '{"name":"com_dtax","type":"component","creationDate":"May 2016","author":"Freddy Flores","copyright":"Copyright (C) 2016 METIK Marketing, LLC. All rights reserved.","authorEmail":"fflores@metikmarketing.com","authorUrl":"https:\\/\\/www.metikmarketing.com","version":"1.0.0","description":"View and control the DTax Application Manager","group":"","filename":"dtax"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10002, 'com_businesssystem', 'component', 'com_businesssystem', '', 1, 1, 0, 0, '{"name":"com_businesssystem","type":"component","creationDate":"May 2017","author":"Freddy Flores","copyright":"Copyright (C) 2017 METIK Marketing, LLC. All rights reserved.","authorEmail":"fflores@metikmarketing.com","authorUrl":"https:\\/\\/www.metikmarketing.com","version":"1.0.0","description":"View and control the Business Development System Manager","group":"","filename":"businesssystem"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `d_finder_filters`
--

CREATE TABLE `d_finder_filters` (
...
--
-- Table structure for table `d_finder_links`
--

CREATE TABLE `d_finder_links` (
...
--
-- Table structure for table `d_finder_links_terms0`
--

CREATE TABLE `d_finder_links_terms0` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `d_finder_links_terms1`
--

CREATE TABLE `d_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `d_finder_links_terms2`
--

CREATE TABLE `d_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `d_finder_links_terms3`
--

CREATE TABLE `d_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `d_finder_links_terms4`
--

CREATE TABLE `d_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `d_finder_links_terms5`
--

CREATE TABLE `d_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `d_finder_links_terms6`
--

CREATE TABLE `d_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `d_finder_links_terms7`
--

CREATE TABLE `d_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `d_finder_links_terms8`
--

CREATE TABLE `d_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `d_finder_links_terms9`
--

CREATE TABLE `d_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `d_finder_links_termsa`
--

CREATE TABLE `d_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `d_finder_links_termsb`
--

CREATE TABLE `d_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `d_finder_links_termsc`
--

CREATE TABLE `d_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `d_finder_links_termsd`
--

CREATE TABLE `d_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `d_finder_links_termse`
--

CREATE TABLE `d_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `d_finder_links_termsf`
--

CREATE TABLE `d_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `d_finder_taxonomy`
--

CREATE TABLE `d_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `d_finder_taxonomy`
--

INSERT INTO `d_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `d_finder_taxonomy_map`
--

CREATE TABLE `d_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `d_finder_terms`
--

CREATE TABLE `d_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `d_finder_terms_common`
--

CREATE TABLE `d_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `d_finder_terms_common`
--

INSERT INTO `d_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `d_finder_tokens`
--

CREATE TABLE `d_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `phrase` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Table structure for table `d_finder_tokens_aggregate`
--

CREATE TABLE `d_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `d_finder_types`
--

CREATE TABLE `d_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `d_languages`
--
...
--
-- Dumping data for table `d_languages`
--

INSERT INTO `d_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
...
(113, 'main', 'COM_DTAX', 'com-dtax', '', 'com-dtax', 'index.php?option=com_dtax', 'component', 0, 1, 1, 10001, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 41, 54, 0, '', 1),
(114, 'main', 'COM_DTAX_TITLE_COMPANY', 'com-dtax-title-company', '', 'com-dtax/com-dtax-title-company', 'index.php?option=com_dtax&view=companys', 'component', 0, 113, 2, 10001, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 42, 43, 0, '', 1),
(115, 'main', 'COM_DTAX_TITLE_EMPLOYEES', 'com-dtax-title-employees', '', 'com-dtax/com-dtax-title-employees', 'index.php?option=com_dtax&view=employees', 'component', 0, 113, 2, 10001, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 44, 45, 0, '', 1),
...
(121, 'main', 'COM_BUSINESSSYSTEM', 'com-businesssystem', '', 'com-businesssystem', 'index.php?option=com_businesssystem', 'component', 0, 1, 1, 10002, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 57, 78, 0, '', 1),
(122, 'main', 'COM_BUSINESSSYSTEM_TITLE_BDSS', 'com-businesssystem-title-bdss', '', 'com-businesssystem/com-businesssystem-title-bdss', 'index.php?option=com_businesssystem&view=cpas', 'component', 0, 121, 2, 10002, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 58, 59, 0, '', 1),
(123, 'main', 'COM_BUSINESSSYSTEM_TITLE_CUSTOMERS', 'com-businesssystem-title-customers', '', 'com-businesssystem/com-businesssystem-title-customers', 'index.php?option=com_businesssystem&view=customers', 'component', 0, 121, 2, 10002, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 60, 61, 0, '', 1),
(124, 'main', 'COM_BUSINESSSYSTEM_TITLE_INVOICES', 'com-businesssystem-title-invoices', '', 'com-businesssystem/com-businesssystem-title-invoices', 'index.php?option=com_businesssystem&view=invoices', 'component', 0, 121, 2, 10002, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 62, 63, 0, '', 1),
(125, 'main', 'COM_BUSINESSSYSTEM_TITLE_EXPENSES', 'com-businesssystem-title-expenses', '', 'com-businesssystem/com-businesssystem-title-expenses', 'index.php?option=com_businesssystem&view=expenses', 'component', 0, 121, 2, 10002, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 64, 65, 0, '', 1),
(126, 'main', 'COM_BUSINESSSYSTEM_TITLE_RECEIPTS', 'com-businesssystem-title-receipts', '', 'com-businesssystem/com-businesssystem-title-receipts', 'index.php?option=com_businesssystem&view=receipts', 'component', 0, 121, 2, 10002, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 66, 67, 0, '', 1),
(127, 'main', 'COM_BUSINESSSYSTEM_TITLE_MILEAGES', 'com-businesssystem-title-mileages', '', 'com-businesssystem/com-businesssystem-title-mileages', 'index.php?option=com_businesssystem&view=mileages', 'component', 0, 121, 2, 10002, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 68, 69, 0, '', 1),
(128, 'main', 'COM_BUSINESSSYSTEM_TITLE_TAXRETURNS', 'com-businesssystem-title-taxreturns', '', 'com-businesssystem/com-businesssystem-title-taxreturns', 'index.php?option=com_businesssystem&view=taxreturns', 'component', 0, 121, 2, 10002, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 70, 71, 0, '', 1),
(129, 'main', 'COM_BUSINESSSYSTEM_TITLE_LINKS', 'com-businesssystem-title-links', '', 'com-businesssystem/com-businesssystem-title-links', 'index.php?option=com_businesssystem&view=links', 'component', 0, 121, 2, 10002, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 72, 73, 0, '', 1),
(130, 'main', 'COM_BUSINESSSYSTEM_TITLE_CONFIG', 'com-businesssystem-title-config', '', 'com-businesssystem/com-businesssystem-title-config', 'index.php?option=com_businesssystem&view=configs', 'component', 0, 121, 2, 10002, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 74, 75, 0, '', 1),
(131, 'main', 'COM_BUSINESSSYSTEM_TITLE_REPORTS', 'com-businesssystem-title-reports', '', 'com-businesssystem/com-businesssystem-title-reports', 'index.php?option=com_businesssystem&view=reports', 'component', 0, 121, 2, 10002, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 76, 77, 0, '', 1);

-- --------------------------------------------------------

--
-- Table structure for table `d_menu_types`
--

CREATE TABLE `d_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(11) NOT NULL,
...
--
-- Dumping data for table `d_menu_types`
--

INSERT INTO `d_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`) VALUES
...
--
-- Table structure for table `d_messages_cfg`
--

CREATE TABLE `d_messages_cfg` (
...
--
-- Dumping data for table `d_modules`
--
...
--
-- Table structure for table `d_modules_menu`
--

CREATE TABLE `d_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `d_modules_menu`
--
...
--
-- Table structure for table `d_newsfeeds`
--

CREATE TABLE `d_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `d_overrider`
--

CREATE TABLE `d_overrider` (
...
--
-- Table structure for table `d_postinstall_messages`
--

CREATE TABLE `d_postinstall_messages` (
...
--
-- Dumping data for table `d_postinstall_messages`
--

INSERT INTO `d_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `d_redirect_links`
--

CREATE TABLE `d_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `d_schemas`
--

CREATE TABLE `d_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `d_schemas`
--

INSERT INTO `d_schemas` (`extension_id`, `version_id`) VALUES
...
INSERT INTO `d_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 70, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `d_template_styles`
--

CREATE TABLE `d_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `d_template_styles`
--

INSERT INTO `d_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `d_ucm_base`
--

CREATE TABLE `d_ucm_base` (
...
--
-- Table structure for table `d_ucm_content`
--

CREATE TABLE `d_ucm_content` (
...
--
-- Table structure for table `d_ucm_history`
--

CREATE TABLE `d_ucm_history` (
...
--
-- Table structure for table `d_updates`
--

CREATE TABLE `d_updates` (
...
--
-- Table structure for table `d_update_sites`
--

CREATE TABLE `d_update_sites` (
...
--
-- Dumping data for table `d_update_sites`
--
...
--
-- Table structure for table `d_update_sites_extensions`
--

CREATE TABLE `d_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Dumping data for table `d_update_sites_extensions`
--

INSERT INTO `d_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 802),
(4, 28);
...
--
-- Table structure for table `d_usergroups`
--

CREATE TABLE `d_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Dumping data for table `d_usergroups`
--

INSERT INTO `d_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `d_user_keys`
--

CREATE TABLE `d_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `d_user_notes`
--

CREATE TABLE `d_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `catid` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Table structure for table `d_user_profiles`
--

CREATE TABLE `d_user_profiles` (
...
--
-- Table structure for table `d_user_usergroup_map`
--

CREATE TABLE `d_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `d_user_usergroup_map`
--
...
--
-- Table structure for table `d_utf8_conversion`
--

CREATE TABLE `d_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `d_utf8_conversion`
--

INSERT INTO `d_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Table structure for table `d_viewlevels`
--

CREATE TABLE `d_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Dumping data for table `d_viewlevels`
--

INSERT INTO `d_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Indexes for table `d_associations`
--
ALTER TABLE `d_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indexes for table `d_banners`
--
ALTER TABLE `d_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `d_banner_clients`
--
ALTER TABLE `d_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Indexes for table `d_banner_tracks`
--
ALTER TABLE `d_banner_tracks`
...
--
-- Indexes for table `d_businesssystem_accounts`
--
ALTER TABLE `d_businesssystem_accounts`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `d_businesssystem_company`
--
ALTER TABLE `d_businesssystem_company`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `d_businesssystem_config`
--
ALTER TABLE `d_businesssystem_config`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `d_businesssystem_cpas`
--
...
--
-- Indexes for table `d_businesssystem_links`
--
ALTER TABLE `d_businesssystem_links`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `d_businesssystem_locations`
--
ALTER TABLE `d_businesssystem_locations`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `d_businesssystem_receipts`
--
ALTER TABLE `d_businesssystem_receipts`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `d_businesssystem_taxreturns`
--
ALTER TABLE `d_businesssystem_taxreturns`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `d_contact_details`
--
ALTER TABLE `d_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indexes for table `d_content`
--
ALTER TABLE `d_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indexes for table `d_contentitem_tag_map`
--
ALTER TABLE `d_contentitem_tag_map`
...
--
-- Indexes for table `d_content_frontpage`
--
ALTER TABLE `d_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `d_content_rating`
--
ALTER TABLE `d_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `d_content_types`
--
...
--
-- Indexes for table `d_dtax_appointments`
--
ALTER TABLE `d_dtax_appointments`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `d_dtax_company`
--
ALTER TABLE `d_dtax_company`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `d_dtax_config`
--
...
--
-- Indexes for table `d_dtax_links`
--
ALTER TABLE `d_dtax_links`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `d_dtax_locations`
--
ALTER TABLE `d_dtax_locations`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `d_dtax_taxreturns`
--
ALTER TABLE `d_dtax_taxreturns`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `d_extensions`
--
ALTER TABLE `d_extensions`
...
--
-- Indexes for table `d_finder_filters`
--
ALTER TABLE `d_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `d_finder_links`
--
ALTER TABLE `d_finder_links`
...
--
-- Indexes for table `d_finder_links_terms0`
--
ALTER TABLE `d_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `d_finder_links_terms1`
--
ALTER TABLE `d_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `d_finder_links_terms2`
--
ALTER TABLE `d_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `d_finder_links_terms3`
--
ALTER TABLE `d_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `d_finder_links_terms4`
--
ALTER TABLE `d_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `d_finder_links_terms5`
--
ALTER TABLE `d_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `d_finder_links_terms6`
--
ALTER TABLE `d_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `d_finder_links_terms7`
--
ALTER TABLE `d_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `d_finder_links_terms8`
--
ALTER TABLE `d_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `d_finder_links_terms9`
--
ALTER TABLE `d_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `d_finder_links_termsa`
--
ALTER TABLE `d_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `d_finder_links_termsb`
--
ALTER TABLE `d_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `d_finder_links_termsc`
--
ALTER TABLE `d_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `d_finder_links_termsd`
--
ALTER TABLE `d_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `d_finder_links_termse`
--
ALTER TABLE `d_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `d_finder_links_termsf`
--
ALTER TABLE `d_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `d_finder_taxonomy`
--
ALTER TABLE `d_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `d_finder_taxonomy_map`
--
ALTER TABLE `d_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indexes for table `d_finder_terms`
--
ALTER TABLE `d_finder_terms`
...
--
-- Indexes for table `d_finder_terms_common`
--
ALTER TABLE `d_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indexes for table `d_finder_tokens`
--
ALTER TABLE `d_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Indexes for table `d_finder_tokens_aggregate`
--
ALTER TABLE `d_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indexes for table `d_finder_types`
--
ALTER TABLE `d_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Indexes for table `d_languages`
--
ALTER TABLE `d_languages`
...
--
-- Indexes for table `d_menu_types`
--
ALTER TABLE `d_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indexes for table `d_messages`
--
...
--
-- Indexes for table `d_messages_cfg`
--
ALTER TABLE `d_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indexes for table `d_modules`
--
ALTER TABLE `d_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `d_modules_menu`
--
ALTER TABLE `d_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indexes for table `d_newsfeeds`
--
ALTER TABLE `d_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indexes for table `d_overrider`
--
ALTER TABLE `d_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `d_postinstall_messages`
--
ALTER TABLE `d_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indexes for table `d_redirect_links`
--
ALTER TABLE `d_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indexes for table `d_schemas`
--
ALTER TABLE `d_schemas`
...
--
-- Indexes for table `d_template_styles`
--
ALTER TABLE `d_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_home` (`home`);

--
-- Indexes for table `d_ucm_base`
--
ALTER TABLE `d_ucm_base`
...
--
-- Indexes for table `d_ucm_content`
--
ALTER TABLE `d_ucm_content`
...
--
-- Indexes for table `d_ucm_history`
--
ALTER TABLE `d_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Indexes for table `d_updates`
--
ALTER TABLE `d_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indexes for table `d_update_sites`
--
ALTER TABLE `d_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indexes for table `d_update_sites_extensions`
--
ALTER TABLE `d_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indexes for table `d_usergroups`
--
ALTER TABLE `d_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `d_user_keys`
--
ALTER TABLE `d_user_keys`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `d_user_notes`
--
ALTER TABLE `d_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indexes for table `d_user_profiles`
--
ALTER TABLE `d_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indexes for table `d_user_usergroup_map`
--
ALTER TABLE `d_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indexes for table `d_viewlevels`
--
ALTER TABLE `d_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `d_banner_clients`
--
ALTER TABLE `d_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `d_businesssystem_accounts`
--
ALTER TABLE `d_businesssystem_accounts`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `d_businesssystem_company`
--
ALTER TABLE `d_businesssystem_company`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `d_businesssystem_config`
--
ALTER TABLE `d_businesssystem_config`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `d_businesssystem_cpas`
--
ALTER TABLE `d_businesssystem_cpas`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
-- AUTO_INCREMENT for table `d_businesssystem_links`
--
ALTER TABLE `d_businesssystem_links`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `d_businesssystem_locations`
--
ALTER TABLE `d_businesssystem_locations`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `d_businesssystem_mileages`
--
ALTER TABLE `d_businesssystem_mileages`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
ALTER TABLE `d_businesssystem_receipts`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `d_businesssystem_taxreturns`
--
ALTER TABLE `d_businesssystem_taxreturns`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
-- AUTO_INCREMENT for table `d_contact_details`
--
ALTER TABLE `d_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `d_content`
--
ALTER TABLE `d_content`
...
--
-- AUTO_INCREMENT for table `d_dtax_appointments`
--
ALTER TABLE `d_dtax_appointments`
...
ALTER TABLE `d_dtax_company`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `d_dtax_config`
--
ALTER TABLE `d_dtax_config`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
-- AUTO_INCREMENT for table `d_dtax_links`
--
ALTER TABLE `d_dtax_links`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `d_dtax_locations`
--
ALTER TABLE `d_dtax_locations`
...
--
-- AUTO_INCREMENT for table `d_finder_filters`
--
ALTER TABLE `d_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `d_finder_links`
--
ALTER TABLE `d_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `d_finder_taxonomy`
--
ALTER TABLE `d_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `d_finder_terms`
--
ALTER TABLE `d_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `d_finder_types`
--
ALTER TABLE `d_finder_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `d_languages`
--
ALTER TABLE `d_languages`
...
ALTER TABLE `d_menu_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `d_messages`
--
ALTER TABLE `d_messages`
  MODIFY `message_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `d_modules`
--
ALTER TABLE `d_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
--
-- AUTO_INCREMENT for table `d_newsfeeds`
--
ALTER TABLE `d_newsfeeds`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `d_overrider`
--
ALTER TABLE `d_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT for table `d_postinstall_messages`
--
ALTER TABLE `d_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `d_redirect_links`
--
ALTER TABLE `d_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `d_tags`
--
ALTER TABLE `d_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `d_template_styles`
--
ALTER TABLE `d_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `d_ucm_content`
--
ALTER TABLE `d_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `d_ucm_history`
--
ALTER TABLE `d_ucm_history`
...
--
-- AUTO_INCREMENT for table `d_usergroups`
--
ALTER TABLE `d_usergroups`
...
ALTER TABLE `d_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `d_user_notes`
--
ALTER TABLE `d_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `d_viewlevels`
--
ALTER TABLE `d_viewlevels`
