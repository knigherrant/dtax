 ...
 */
class BusinessSystemControllerFiles extends JControllerAdmin
{
    ...
    public function getModel($name = 'file', $prefix = 'BusinessSystemModel', $config = array('ignore_request' => true))
    {
