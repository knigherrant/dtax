...
<form action="<?php echo JRoute::_('index.php?option=com_businesssystem&view=taxreturns'); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <thead>
            <tr>
             ...
             -->
				...
				<th class="left">
					<?php echo JHtml::_('grid.sort',  'BDS', 'c.cpa', $listDirn, $listOrder); ?>
				</th>
        ...
        <tbody>
            ...
            foreach ($this->items as $i => $item) :
                ...
                <tr class="row<?php echo $i % 2; ?>">
					...
					<?php endif; ?>
					<?php if ($canEdit): ?>
						<a href="<?php echo JRoute::_('index.php?option=com_businesssystem&task=taxreturn.edit&id=' . (int) $item->id); ?>">
