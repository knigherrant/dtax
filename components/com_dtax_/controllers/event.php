 ...
 */
class DTaxControllerEvent extends JControllerForm
{
    ...
    function saveComment(){
        ...
        $this->setRedirect(JRoute::_('index.php?option=com_dtax&view=event&layout=view&id='.$input->getInt('item_id').'&Itemid='.$input->getInt('Itemid')), $msg);
        return;
    }
