 ...
 */
class DTaxControllerRequest extends JControllerForm
{
    ...
    function saveComment(){
        ...
        $this->setRedirect(JRoute::_('index.php?option=com_dtax&view=request&layout=view&id='.$input->getInt('item_id').'&Itemid='.$input->getInt('Itemid')), $msg);
        return;
    }
