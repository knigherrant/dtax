...
?>
<?php echo JST::header(); ?>
<?php echo JST::toolbar('locations'); ?>
<?php JST::tabsMenuOfice(); ?>

<script type="text/javascript">
            Joomla.submitbutton = function(task)
            {
                if (task == 'locations.cancel') {
                    Joomla.submitform(task, document.getElementById('locations-form'));
                }
                else{
                    
                    if (task != 'locations.cancel' && document.formvalidator.isValid(document.id('locations-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_dtax&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="locations-form" class="form-validate">
...
<form action="<?php echo JRoute::_('index.php?option=com_dtax&view=locations'); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <tbody>
            ...
            foreach ($this->items as $i => $item) :
                ...
                <tr class="row<?php echo $i % 2; ?>">
					...
					<?php endif; ?>
					<?php if ($canEdit): ?>
						<a href="<?php echo JRoute::_('index.php?option=com_dtax&task=location.edit&id=' . (int) $item->id); ?>">
