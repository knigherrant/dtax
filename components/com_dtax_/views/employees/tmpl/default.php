...
?>
<?php echo JST::header(); ?>
<?php echo JST::toolbar('employee', true); ?>
<?php JST::tabsMenuOfice(); ?>
<form action="<?php echo JRoute::_('index.php?option=com_dtax&view=employees'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <table class="table table-striped">
        <thead>
            <tr>
				...
				<th class="left">
					<?php echo JHtml::_('grid.sort',  'Employee', 'a.employee', $listDirn, $listOrder); ?>
				</th>
				<th class="left">
            ...
            foreach ($this->items as $i => $item) :
                ...
                <tr class="row<?php echo $i % 2; ?>">
					...
					<?php if (isset($item->checked_out) && $item->checked_out) : ?>
						<?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'employees.', $canCheckin); ?>
					<?php endif; ?>
					<?php if ($canEdit): ?>
						<a href="<?php echo JRoute::_('index.php?option=com_dtax&task=employee.edit&id=' . (int) $item->id); ?>">
