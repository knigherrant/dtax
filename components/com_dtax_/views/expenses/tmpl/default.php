...
?>
<?php echo JST::header(); ?>
<?php echo JST::toolbar('expense', true); ?>
<form action="<?php echo JRoute::_('index.php?option=com_dtax&view=expenses'); ?>" method="post" name="adminForm" id="adminForm">
   <div class="jsContents form-horizontal row-fluid jscustom12">  
            <div id="j-main-container">
               <legend><?php echo JText::_('Expenses');?></legend>
                <?php JST::tabsMenu(); ?>
        ...
        <tbody>
            ...
            foreach ($this->items as $i => $item) :
                ...
                <tr class="row<?php echo $i % 2; ?>">
					...
					<?php endif; ?>
					<?php if ($canEdit): ?>
						<a href="<?php echo JRoute::_('index.php?option=com_dtax&task=expense.edit&id=' . (int) $item->id); ?>">
